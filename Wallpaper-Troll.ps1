############################################################################################################################################################                      
#                                  |                                                                         #              ,d88b.d88b                     #                                 
# Title        : Wallpaper-Troll   |                                                                         #              88888888888                    #           
# Author       : I am Jakoby       |                                                                         #              `Y8888888Y'                    #           
# Version      : 1.0               |                                                                         #               `Y888Y'                       #
# Category     : Prank             |                                                                         #                 `Y'                         #
...
$hiddenMessage = "`n`nMy crime is that of curiosity `nand yea curiosity killed the cat `nbut satisfaction brought him back `n with love -pwned by matt"

# this will be the name of the image you use as the wallpaper

$ImageName = "pwned-by-matt-lmao"
